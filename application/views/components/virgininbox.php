								        ...
								        <!-- content goes here -->
											<div class="inbox-body" id="inbox-body-js">
												...
												<div class="inbox-body-content" id="inbox-loading-panel-js">
													...
													<h3 class="message-from">From [user name]</h3>
													...
													<div class="message-container">
														...
														<div class="message-body">
															...
															<div class="past-message">
																...
																<p>Sincerely,<br/> Victoria Bitter</p>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="inbox-menu">
												<div class="inbox-control-panel">
													<a href="javascript:void(0)" id='refresh-inbox-menu' class="btn medium pull-right"><i class="icon-refresh"></i> Refresh</a>
												</div>
												<!-- SLIDING MENU -->
